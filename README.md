<h1 align="center">Hi, I'm Ebi Mhmdl 👨‍💻</h1>
<h3 align="center">AI Engineer | C++ and Python Developer | ML and NLP Specialist</h3>

<p align="center">
  <a href="https://github.com/EbiAraz">
    <img src="https://komarev.com/ghpvc/?username=EbiAraz&label=Profile%20views&color=0e75b6&style=flat" alt="profile views" />
  </a>
  <a href="mailto:ebimahmudi1987@gmail.com">
...
## ⭐ Tech Stack
<p>
  <img src="https://skillicons.dev/icons?i=cpp,python,html,css,flask,fastapi,postgres,mysql,docker,git,github,vscode" alt="Tech stack" />
</p>

## ⭐ Featured Work
- [RAG-PDF-PROJECT](https://huggingface.co/spaces/EbiAraz/RAG-PDF-Project): the interface applications of RAG-PDF-PROJECT (click the link to running in huggingface)
- [semantic-RAG](https://huggingface.co/spaces/EbiAraz/semantic-rag): the interface applications of semantic-RAG (click the link to running in huggingface)
...
- [-Catch-Game-with-DQN](https://github.com/EbiAraz/-Catch-Game-with-DQN): DQN agent for the Catch game with reward-driven policy learning.
